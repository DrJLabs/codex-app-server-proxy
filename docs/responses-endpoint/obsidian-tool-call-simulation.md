...
> **Purpose**: This strategy doc includes inline fix comments describing concrete changes required to achieve closer **OpenAI Responses API** parity while operating within Codex app-server JSON-RPC constraints.
>
> **Comment legend**
